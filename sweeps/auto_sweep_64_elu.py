...
def train_sweep():
    ...
    print(f"\n{'=' * 50}")
    print(f"Starting 64 ELU sweep run")
...
if __name__ == "__main__":
    ...
    sweep_id = wandb.sweep(sweep_config, project="auto_64_elu")
    print("\nStarting sweep for 64 ELU architecture")
