...
print('running auto_sweep_512_elu.py')
...
def train_sweep():
    ...
    print(f"\n{'=' * 50}")
    print(f"Starting 512 ELU sweep run")
...
if __name__ == "__main__":
    ...
    sweep_id = wandb.sweep(sweep_config, project="auto_512_elu")
    print("\nStarting sweep for 512 ELU architecture")
