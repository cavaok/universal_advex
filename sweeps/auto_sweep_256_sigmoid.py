...
print('running auto_256_sigmoid.py')
...
def train_sweep():
    ...
    print(f"\n{'=' * 50}")
    print(f"Starting 256 Sigmoid sweep run")
...
if __name__ == "__main__":
    ...
    sweep_id = wandb.sweep(sweep_config, project="auto_256_sigmoid")
    print("\nStarting sweep for 256 Sigmoid architecture")
