...
def train_sweep():
    ...
    print(f"\n{'=' * 50}")
    print(f"Starting 256 ELU sweep run")
...
if __name__ == "__main__":
    ...
    sweep_id = wandb.sweep(sweep_config, project="auto_256_elu")
    print("\nStarting sweep for 256 ELU architecture")
