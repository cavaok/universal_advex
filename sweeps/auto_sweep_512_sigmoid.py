...
print('running auto_512_sigmoid.py')
...
def train_sweep():
    ...
    print(f"\n{'=' * 50}")
    print(f"Starting 512 Sigmoid sweep run")
...
if __name__ == "__main__":
    ...
    sweep_id = wandb.sweep(sweep_config, project="auto_512_sigmoid")
    print("\nStarting sweep for 512 Sigmoid architecture")
